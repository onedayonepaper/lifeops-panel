...
const jobCategories: JobCategory[] = [
  ...
  },
  {
    ...
    title: 'GIST (광주과학기술원)',
    icon: '🔬',
    description: '학내 정보시스템 개발/운영, 정보보안, 네트워크 인프라 관리 등 대학 IT 전문직',
    requirements: [
      '학력: 4년제 대학교 학사학위 이상',
      '채용유형: 주로 경력직 (IT개발, 정보보안)',
      '관련 전공: 컴퓨터공학, 소프트웨어공학, 정보통신 등',
      '자격증 우대: 정보처리기사, 정보보안기사 등',
      '결격사유: 국가공무원법 제33조 해당 없을 것',
    ],
    examSubjects: [
      '1단계: 서류전형 (5배수 내외 선발)',
      '2단계: 자격 검증 (지원자격 서류 확인)',
      '3단계: 면접전형 (직무역량, 인성 평가)',
      '최종: 평가 만점의 70% 이상 고득점 순',
    ],
    benefits: [
      '비영리법인 공공기관 안정성',
      '정규직 평균 근속 13년 2개월',
    ...
    links: [
      { label: 'GIST 채용 포털', url: 'https://gist.recruiter.co.kr/' },
      { label: 'GIST 채용공고', url: 'https://ewww.gist.ac.kr/kr/html/sub06/060103.html' },
      { label: '잡코리아 GIST', url: 'https://www.jobkorea.co.kr/company/1867175/recruit' },
    ],
    notes: [
      'IT개발: 학내 정보시스템(ZEUS 등) 개발 및 운영',
      '정보보안: 보안관제, 침해사고 대응, 취약점 분석',
      '직원 수 약 472명 (정규직 319명)',
      'NCS 기반 채용 프로세스 적용',
      '주로 하반기(8~9월)에 정규직 채용 공고',
      '근무지: 광주광역시 북구 첨단과기로 123',
    ],
  },
]
