...
const FIXED_ROUTINES = [
  ...
  { id: 'r-3', label: '(취업) 취업루틴', detail: '공고 검색 > 이력서 맞춤 수정 > 자소서 작성 > 포폴 정리', category: '취업', order: 10, location: '집', actionUrl: '/employment', actionLabel: '취업관리', time: '19:20~19:50' },
  { id: 'r-12', label: '(취업) 면접 준비', detail: '기술면접 질문 1개 답변 정리 + 인성면접 예상 질문 연습', category: '취업', order: 11, location: '집', time: '19:50~20:20' },
  ...
  { id: 'r-16', label: '(건강) 헬스', detail: '근력운동 40분 (스쿼트/벤치프레스/데드리프트/로우) + 스트레칭 10분', category: '건강', order: 14, location: '집', time: '18:00~18:50' },
]
