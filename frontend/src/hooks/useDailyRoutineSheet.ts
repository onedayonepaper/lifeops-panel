...
const FIXED_ROUTINES = [
  { id: 'r-15', label: '(건강) 러닝', detail: '워밍업 5분 → 러닝 30분 → 쿨다운 5분 (05:20~06:00)', category: '건강', order: 0, location: '집', time: '05:20~06:00' },
  ...
  { id: 'r-17', label: '(건강) 산책/스트레칭', detail: '가벼운 산책 or 스트레칭 20분', category: '건강', order: 15, location: '독서실', time: '12:20~12:40' },
